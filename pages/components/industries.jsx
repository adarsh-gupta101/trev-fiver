...
function Industries() {
  ...
  return (
    <div
      ...
      <p className='text-4xl mt-12  text-center md:text-4xl text-gray-500 p-2 md:p-0'>
        Industries
      </p>
      ...
      <h1
        ...
        style={{
          height: "80vh",
          backgroundImage:
            "url(`https://img.freepik.com/free-vector/white-abstract-background-3d-paper-style_23-2148403778.jpg?w=2000`)",
        }}>
